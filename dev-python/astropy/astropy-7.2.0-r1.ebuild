...
"
RDEPEND="${DEPEND}
	>=dev-python/astropy-iers-data-0.2025.12.1.0.45.12[${PYTHON_USEDEP}]
...
PATCHES=(
	"${FILESDIR}/${P}-fix-_POSIX_C_SOURCE-redefined.patch"
)
...
pkg_postinst() {
	...
	optfeature "generic DataFrame conversion" dev-python/narwhals
}
