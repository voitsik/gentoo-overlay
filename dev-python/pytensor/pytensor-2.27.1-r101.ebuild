...
EGIT_COMMIT='51ea1a0b45da5de97a62c10f24b593270ea1be46'
MY_P=${PN}-${EGIT_COMMIT}
...
"
SRC_URI="
	https://github.com/pymc-devs/pytensor/archive/${EGIT_COMMIT}.tar.gz
		-> ${MY_P}.gh.tar.gz
"
...
python_test() {
	...
	local EPYTEST_DESELECT=(
		'tests/tensor/test_math.py::TestMinMax::test_uint[uint64]'
	)
