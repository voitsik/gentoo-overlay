...
EGIT_COMMIT='ecfd045443a65df6c00245187fe4c4140b28c2ca'
MY_P=${PN}-${EGIT_COMMIT}
...
"
SRC_URI="
	https://github.com/brendan-m-murphy/pytensor/archive/${EGIT_COMMIT}.tar.gz
		-> ${MY_P}.gh.tar.gz
"
...
PATCHES=( "${FILESDIR}/${MY_P}-fix.patch" )
